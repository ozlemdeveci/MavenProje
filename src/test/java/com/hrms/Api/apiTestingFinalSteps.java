...
//    Response responseToRetrieveCreatedEmployee;
    ...
    public void the_retrieved_data_at_matches_the_data_used_to_create_the_employee_with_employee_ID(String employeeObject, String responseEmployeeID) {
...
//            System.out.println(allEmployeeIDs);
        ...
        //get employee firstname of each employee in syntax hrms data base
        ...
        for (JsonElement x:array_ofAllEmployees){
           ...
           String employee_firstname=Employee_data.get("emp_firtsname").getAsString();
    ...
    public void it_contains_the_value1_value2(String value1, String value2) {
       ...
       // response.then().assertThat().body(containsString(value1)).body(containsString(value2));
        String response_string=response.asString();
        JsonObject response_getAllEmployee=JsonParser.parseString(response_string).getAsJsonObject();
        JsonElement Employee_status_list=response_getAllEmployee.get("Employee Status List");
        System.out.println(Employee_status_list); //simpliy print
